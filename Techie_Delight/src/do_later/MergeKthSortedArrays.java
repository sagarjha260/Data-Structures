...
{ 
	...
	public MergeKthSortedArrays(MinHeapNode a[], int size) 
	{ 
		heap_size = size; 
		harr = a; 
		int i = (heap_size - 1)/2; 
	...
	{ 
		...
		MergeKthSortedArrays mh = new MergeKthSortedArrays(hArr, k); 
